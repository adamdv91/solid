...
import static com.adamdevilliers.solid.fragment.DisplayMallsFragment.MALL_ID;

public class ShopsInMallFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        int getCityValue = getArguments().getInt(MALL_ID);
        ...
        solidSdk.getShops(getCityValue, new SolidCallback<List<Shop>>() {
            @Override
